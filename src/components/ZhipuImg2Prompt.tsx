...
export default function ZhipuImg2Prompt({
  ...
  const historyCtrl = useHistory<Img2PromptHistoryItem>(ZHIPU_STORAGE_KEYS.IMG2PROMPT_HISTORY)
  ...
  return (
    <div>
      ...
      <div className="sensenova-model-desc">
        使用 {ZHIPU_VISION_MODEL} 多模态视觉模型，上传参考图片即可反推生成适配 CogView-3-Flash 的结构化提示词，支持中英文输出，一键填入文生图。
      </div>
      ...
      {isLoading && (
        <div className="agnes-loading-box">
          ...
          <div className="agnes-loading-text agnes-loading-dots">{ZHIPU_VISION_MODEL} 正在分析图片，生成提示词</div>
